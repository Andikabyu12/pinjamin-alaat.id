...
@section('title', 'Data Peminjaman - Kakonsli SIJA')
    ...
    <div class="card-soft rounded-2xl p-8 border border-slate-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-slate-600">Pantau semua peminjaman alat siswa</p>
            </div>
            <a href="{{ route('kaonsli_sij.search-peminjaman') }}" class="inline-flex items-center gap-2 gradient-btn text-white px-6 py-3 rounded-lg hover:shadow-lg transition">
            ...
            <table class="w-full">
                <thead class="bg-slate-100 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold text-slate-900">Nama Siswa</th>
